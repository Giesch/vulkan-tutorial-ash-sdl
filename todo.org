...
* Current
- [-] split into crate workspace
  - [X] move game code into examples
    - [X] basic triangle
    - [X] depth texture
    - [X] viking room
  - [ ] move generated example code into example dirs
  - [ ] make codegen runnable if game doesn't compile
  - [ ] aim for supporting roc/mun/luau

- [ ] support more parameter types
  - [ ] write-only storage buffers
  - [ ] read-write storage buffers
    for supporting 'picking' / mouse interaction
  - [ ] push constants?

- [ ] use do_not_recommend for Game subtraits
  https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/#hiding-trait-implementations-from-diagnostics

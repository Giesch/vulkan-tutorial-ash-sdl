...
- [-] reproduce slangc's json reflection
  ...
  - [-] global parameters
    ...
    - [-] include binding/index/offset
      ...
      - [X] struct fields
      - [X] entry point params
        what are these bindings used for? look at slang-rhi?
      - [-] global parameters
        parameter blocks should not have bindings themselves
        and the inner struct is handled already

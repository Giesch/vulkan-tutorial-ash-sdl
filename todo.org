...
* Current
- [ ] update generated code to make entry points optional
  ie; the interface used by renderer
  - [ ] update in place
    - [ ] vertex
    - [ ] fragment
  - [ ] update templates & regenerate

- [ ] update reflection to make entry points optional
  - [ ] vertex
  - [ ] fragment
  - [ ] require at least one in codegen?

- [ ] solid color example
  - [ ] make vertex entry point optional
    - [ ] conditionally remove vertex/index buffers

- [ ] basic triangle example
  - [ ] make fragment entry point optional
  - [ ] make ParameterBlock optional
    - [ ] conditionally remove uniform buffer in Resources

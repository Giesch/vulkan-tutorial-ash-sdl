...
** link
[[https://docs.shader-slang.org/en/latest/parameter-blocks.html#entry-points]]
...
- the default descriptor set holds all uniforms not in a ParameterBlock
  ie, potentially one from each entry point and one global one
- a rust slang::reflection::Shader is a wrapped cpp slang::ProgramLayout

* Next
- [ ] slang reflection codegen
  - [ ] descriptor sets from parameter blocks
    [[https://docs.shader-slang.org/en/latest/parameter-blocks.html#what-goes-into-a-descriptor-set-layout]]

...
- [ ] generate vertex attributes?
  or make th vetex type part of the api, like lazyvulkan
  https://github.com/leetvr/lazy_vulkan
  this would also need a matching slang module
  - discord links
  ...
  - [ ] look at slangc reflection json implementation
    ...
    https://github.com/shader-slang/slang/blob/master/source/slang/slang-reflection-json.cpp#L1050
    - bindings
...
- [X] fix bug where descriptor set layout is not freed on teardown after a hot reload?
  ...
  - [X] need old_compiled_shaders just like old_pipelines
    specifically to get the descriptor set layouts

...
* Current
- [ ] add tests/assertions that generated struct fields are ordered correctly
  assert before source gen (leave the game runnable)
  assertions before codegen or generated unit tests?

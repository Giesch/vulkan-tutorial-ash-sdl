...
impl Game for PixelRickGame {
        ...
        Self: Sized,
    {
        ...
        let shader = shader_atlas.pixel_rick;

        let pixel_rick_buffer = renderer.create_uniform_buffer::<PixelRick>()?;

        let resources = PixelRickResources {
            vertices,
            indices,
            pixel_rick_buffer: &pixel_rick_buffer,
        };
